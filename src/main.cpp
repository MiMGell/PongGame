...
Color botSide = Color{0, 150, 85, 255};
...
int main (void) 
{
    ...
    bot.width = 20;
    bot.height = 100;
    bot.x = screen_width - 45;
    bot.y = screen_height/2 - 40 - (bot.height/2);
    bot.speed = 0;
    ...
    bot_Match.x = GetScreenWidth()/2 - 45;
    bot_Match.y = GetScreenHeight()/2 + 25;
    bot_Match.width = 90;
    bot_Match.height = 45;
    ...
    while (WindowShouldClose() == false) 
    {
        ...
        case MainMenu:
            ...
            DrawTexture(vsAi_txture, bot_Match.x, bot_Match.y, WHITE);
            ...
            if (CheckCollisionPointRec(Vector2{mousePoint}, Rectangle{bot_Match.x, bot_Match.y, bot_Match.width, bot_Match.height}))
            {
                DrawTexture(vsAiOnH_txture, bot_Match.x, bot_Match.y, WHITE);
                DrawTexture(ball_txture, bot_Match.x - 25, bot_Match.y + 13, WHITE);
        ...
        case GameAI:
            ...
            DrawRectangle(GetScreenWidth()/2, 0, GetScreenWidth()/2, GetScreenHeight() - 55, botSide);
            ...
            DrawRectangleRounded(Rectangle{bot.x - 7, bot.y + 7, bot.width, bot.height}, 0.8, 0, shadow);
            sap.Draw();
            ...
            DrawTexture(paddle_txture, bot.x, bot.y, WHITE);
